...
Ако не си бил/а на упражнение или не си схванал/а точните стъпки за инсталация и създаване на C++ проект може да изгледаш **това видео:** https://www.youtube.com/watch?v=IsAoIqnNia4&ab_channel=KodySimpson
...
- Модификатори: 
  - unsigned char [0, 255]
    Интересно: Всъщност знаците са числа.(Всичко се свежда до числа :) ). Какъв ли е резултатът от това:
