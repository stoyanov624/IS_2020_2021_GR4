...
## Task 1
## Напишете следните функции (Сами преценете какъв е списъкът от параметри при всяка функция!)
...
## Task 3 - %%%
###  Да се напише функция, която по подадени две цели числа, които съответсват на цена и процент отстъпка, връща като резултат намалената цена.
...
**Примерен изход при вход traycho@gmail.com:** Valid email.

**Примерен изход при вход trai40gmail.com:** Missing @

**Примерен изход при вход FMI@gmail.com:** Email name not long enough
