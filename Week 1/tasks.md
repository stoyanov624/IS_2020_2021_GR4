...
**Примерен изход при вход 0 :** From C to F -> 32.00 F, From F to C -> -17.777.

**Примерен изход при вход 15 :** From C to F -> 59.00 F, From F to C -> -9.44.

**Примерен изход при вход 32 :** From C to F -> 89.60 F, From F to C -> 0.
